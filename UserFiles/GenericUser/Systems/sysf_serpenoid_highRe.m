function output = sysf_serpenoid_highRe(input_mode,pathnames)
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'HighRe swimmer: Serpenoid'; % Display name
...
function [Ar]=Conn_num(a1,a2)
		...
		Ar =  HighRE_local_connection_from_curvature_bases({@serpenoid_1;@serpenoid_2},[a1;a2],1);
%         Ar = Inertial_local_connection_from_curvature_bases(kappa_basis_input,r,L,density);

function output = sysf_serpenoid_granular_2016(input_mode,pathnames)
...
% file, instead of generating it programmatically.
    ...
    Local_connection = 'SerpenoidGranularConnection2016.mat';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Serpenoid Granular Swimmer'; % Display name
...
A = four_way_symmetry(alpha1, alpha2, -Ax1, -Ax2, -Ay1, -Ay2, -Atheta1,-Atheta2, a1, a2, 1, averaging_mode);

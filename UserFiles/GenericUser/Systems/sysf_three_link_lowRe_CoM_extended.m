function output = sysf_three_link_lowRe_CoM_extended(input_mode,pathnames)
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Viscous Swimmer: 3-link CoM_extended'; % Display name

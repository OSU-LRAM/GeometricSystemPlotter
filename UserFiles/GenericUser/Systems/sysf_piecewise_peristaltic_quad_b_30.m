function output = sysf_piecewise_peristaltic_quad_b_30(input_mode,pathnames)
...
%     curvdef = 'a1*heaviside(-s)+a2*heaviside(s)';
    ...
    % no decimal issues
    curvdef_name = 'piecewise_peristaltic_quad_b_30';
	...
	switch input_mode
		...
		case 'name'
			...
			output = ['Piecewise Peristaltic Snake, b = ',num2str(stretch_const),', quad']; % Display name

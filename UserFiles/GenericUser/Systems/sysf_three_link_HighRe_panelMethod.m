function output = sysf_three_link_HighRe_panelMethod(input_mode,pathnames)
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'HighRe Swimmer, Panel Method: 3-link ellipses'; % Display name

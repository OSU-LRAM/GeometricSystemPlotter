function output = sysf_serpenoid_peristaltic_100(input_mode,pathnames)
    ...
    % no decimal issues
    curvdef_name = ['serpenoid_peristaltic_b_',num2str(stretch_const*1000)]; 
	%%%%%%%
	...
	switch input_mode
		...
		case 'name'
			...
			output = ['Serpenoid Peristaltic Snake, b = ',num2str(stretch_const),', quad']; % Display name

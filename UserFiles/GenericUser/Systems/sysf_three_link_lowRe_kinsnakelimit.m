function output = sysf_three_link_lowRe_kinsnakelimit(input_mode,pathnames)
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Kinematic Snake, from LowRe'; % Display name
		...
		case 'initialize'
            ...
            s.physics.drag_ratio.longitudinal = 1/10000;
            s.physics.drag_ratio.lateral = 10000;
            s.physics.drag_ratio.rotational = 1/10000;

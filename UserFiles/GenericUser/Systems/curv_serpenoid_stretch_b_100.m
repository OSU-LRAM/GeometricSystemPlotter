% a01.*1c*o(sa(12**cpois*(s2)*+pai2**ss)i+na(22**spiin*(s2)* p i * s ) ) ^ 2 + 1
function output = curv_serpenoid_stretch_b_100(params,mode)
...
function out1 = dstretch_fun(s,a1,a2)
	...
	t6 = a2.*t4;
	t7 = t5+t6;
	out1 = [t3.*t7.*2.0e-1,t4.*t7.*2.0e-1];
end

function output = sysf_triangle_lowRe(input_mode,pathnames)
	...
	switch input_mode
		...
		case 'initialize'
            ...
            % sharpness power
            triangle_wave_curvature = subs(triangle_wave_curvature,{'omega','n'},{1 10});
            ...
            % metric calculations)
            curvdef_fun = make_curvdef(triangle_wave_curvature,{'a1' 'a2'},curvdef_name,[1,0,0,0],pathnames.syspath,pathnames.sysplotterpath);
%             

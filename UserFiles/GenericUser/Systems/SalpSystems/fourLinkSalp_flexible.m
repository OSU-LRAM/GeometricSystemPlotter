function salp = threeLinkSalp_flexible(inputmode)  
    ...
    %%%%%%
    %% Body geometry
    swimmerName = 'Four-Link Salp Continuous Curvature';
    ...
    switch inputmode
        ...
        case 'getSwimmerSystem'
            ...
            s.geometry.function = @curv_PiecewiseCC_4Sections;
            s.geometry.nShapes = 4;
            ...
            s.geometry.thrusters.thrusterArcLengths = [1/8:1/4:7/8]-.5; 

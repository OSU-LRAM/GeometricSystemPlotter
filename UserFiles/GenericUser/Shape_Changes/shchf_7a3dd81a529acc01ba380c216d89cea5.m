function output = shchf_7a3dd81a529acc01ba380c216d89cea5(input_mode,pathnames)
	...
	paramfile = '7a3dd81a529acc01ba380c216d89cea5';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [HighRe CC, 3 Mode] [Circle Stroke, 6 amplitude] [covariant acceleration] Xeff';

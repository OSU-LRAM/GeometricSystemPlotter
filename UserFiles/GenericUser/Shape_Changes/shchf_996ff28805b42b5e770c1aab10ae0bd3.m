function output = shchf_996ff28805b42b5e770c1aab10ae0bd3(input_mode,pathnames)
	...
	paramfile = '996ff28805b42b5e770c1aab10ae0bd3';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [HighRe ideal swimmer: 4-link ellipses] [Opt: [HighRe ideal swimmer: 4-link ellipses] [Circle Stroke, 1.0 amplitude] Xeff] [covariant acceleration] Xeff';

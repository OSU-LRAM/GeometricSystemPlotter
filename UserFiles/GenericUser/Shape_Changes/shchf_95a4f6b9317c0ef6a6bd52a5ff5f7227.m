function output = shchf_95a4f6b9317c0ef6a6bd52a5ff5f7227(input_mode,pathnames)
	...
	paramfile = '95a4f6b9317c0ef6a6bd52a5ff5f7227';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [Inertial floating: 3-link ellipses] [Opt: [Inertial floating: 3-link ellipses] [Circle Stroke, 1.0 amplitude offset for turning] Xeff] Xeff';

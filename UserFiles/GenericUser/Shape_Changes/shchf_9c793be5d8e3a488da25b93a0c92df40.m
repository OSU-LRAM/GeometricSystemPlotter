function output = shchf_9c793be5d8e3a488da25b93a0c92df40(input_mode,pathnames)
	...
	paramfile = '9c793be5d8e3a488da25b93a0c92df40';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [Inertial floating: 4-link ellipses] [Circle Stroke, 0.25 amplitude offset for turning] [covariant acceleration] Xeff';

function output = shchf_a02c3dd8832e1178c3622b5723148554(input_mode,pathnames)
	...
	paramfile = 'a02c3dd8832e1178c3622b5723148554';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [Inertial floating: 4-link ellipses] [Opt: [Inertial floating: 4-link ellipses] [Circle Stroke, 0.25 amplitude offset for turning] [pathlength metric] Xeff] [pathlength metric] Xeff';

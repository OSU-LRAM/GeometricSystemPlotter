function output = shchf_1120f0b1d219a6eb0fc7dff6ce8d0b11(input_mode,pathnames)
	...
	paramfile = '1120f0b1d219a6eb0fc7dff6ce8d0b11';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [HighRe ideal swimmer: 4-link ellipses] [Opt: [HighRe ideal swimmer: 4-link ellipses] [Opt: [HighRe ideal swimmer: 4-link ellipses] [Opt: [HighRe ideal swimmer: 4-link ellipses] [Circle Stroke, 1.0 amplitude] Xeff] Xeff] Xeff] Xeff';

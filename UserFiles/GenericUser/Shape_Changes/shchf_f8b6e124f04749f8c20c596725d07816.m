function output = shchf_f8b6e124f04749f8c20c596725d07816(input_mode,pathnames)
	...
	paramfile = 'f8b6e124f04749f8c20c596725d07816';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [5-Link Flapper with Passive Joints] [Opt: [5-Link Flapper with Passive Joints] [Opt: [5-Link Flapper with Passive Joints] [Opt: [5-Link Flapper with Passive Joints] [Opt: [Viscous Swimmer: 3-link] [Opt: [Viscous Swimmer: 3-link] [Circle Stroke, 1.0 amplitude] Xeff] Xeff] Xeff] Xeff] Xeff] Xeff';

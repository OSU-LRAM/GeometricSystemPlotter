function output = shchf_params_circle_1_3shapevariables(input_mode,pathnames)
	...
	paramfile = 'params_circle_1_3shapevariables';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Circular gaits: Amplitude 1, 3 shape variables';

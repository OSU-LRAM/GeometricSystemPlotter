function output = shchf_24b347f2c0a3bbf334e20cf1e121cc0e(input_mode,pathnames)
	...
	paramfile = '24b347f2c0a3bbf334e20cf1e121cc0e';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [Viscous Swimmer: 3-link] [Opt: [Viscous Swimmer: 3-link] [Circle Stroke, 1.0 amplitude] Xeff] Xeff';

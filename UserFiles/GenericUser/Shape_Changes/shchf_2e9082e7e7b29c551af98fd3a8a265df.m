function output = shchf_2e9082e7e7b29c551af98fd3a8a265df(input_mode,pathnames)
	...
	paramfile = '2e9082e7e7b29c551af98fd3a8a265df';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [Inertial floating: 3-link ellipses] [Circle Stroke, 0.25 amplitude offset for turning] [covariant acceleration] Xeff';

function output = shchf_7cc66105524a812661e6bcbfd9c3b051(input_mode,pathnames)
	...
	paramfile = '7cc66105524a812661e6bcbfd9c3b051';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [Inertial floating: 3-link ellipses] [Opt: [Inertial floating: 3-link ellipses] [Opt: [Inertial floating: 3-link ellipses] [Opt: [Inertial floating: 3-link ellipses] [Circle Stroke, 1.0 amplitude] Xeff] Xeff] Xeff] Xeff';

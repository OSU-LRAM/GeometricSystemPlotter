function output = shchf_9fc864c4064e3b2a21dd679484963e56(input_mode,pathnames)
	...
	paramfile = '9fc864c4064e3b2a21dd679484963e56';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [Inertial floating: 3-link ellipses] [Circle Stroke, 1.0 amplitude] Xeff';

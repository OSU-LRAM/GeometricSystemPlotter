function output = shchf_7d753475ee14eae2e2715f3cd67f3f23(input_mode,pathnames)
	...
	paramfile = '7d753475ee14eae2e2715f3cd67f3f23';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [HighRe ideal swimmer: 3-link ellipses] [Opt: [HighRe ideal swimmer: 3-link ellipses] [Circle Stroke, 1.0 amplitude] [covariant acceleration] Xeff] [covariant acceleration] Xeff';

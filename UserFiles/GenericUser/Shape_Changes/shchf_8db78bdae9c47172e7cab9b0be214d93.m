function output = shchf_8db78bdae9c47172e7cab9b0be214d93(input_mode,pathnames)
	...
	paramfile = '8db78bdae9c47172e7cab9b0be214d93';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [HighRe Continuous Approx: 20-link ellipses, Serpenoid] [Circle Stroke, 1.0 amplitude] Xeff';

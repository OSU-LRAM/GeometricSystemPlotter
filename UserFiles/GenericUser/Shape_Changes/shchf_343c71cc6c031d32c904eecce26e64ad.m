function output = shchf_343c71cc6c031d32c904eecce26e64ad(input_mode,pathnames)
	...
	paramfile = '343c71cc6c031d32c904eecce26e64ad';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [HighRe ideal swimmer: 5-link ellipses] [Opt: [HighRe ideal swimmer: 5-link ellipses] [Circle Stroke, 1.0 amplitude] [torque] Xeff] [torque] Xeff';

function output = shchf_7a2ab8cd3a1e3ed78e28f13afcb08fdc(input_mode,pathnames)
	...
	paramfile = '7a2ab8cd3a1e3ed78e28f13afcb08fdc';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [HighRe ideal swimmer: 3-link ellipses] [Circle Stroke, 1.0 amplitude] Xeff';

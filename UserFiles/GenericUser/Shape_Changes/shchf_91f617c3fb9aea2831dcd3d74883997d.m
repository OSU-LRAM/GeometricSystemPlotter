function output = shchf_91f617c3fb9aea2831dcd3d74883997d(input_mode,pathnames)
	...
	paramfile = '91f617c3fb9aea2831dcd3d74883997d';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [HighRe Continuous Approx: 20-link ellipses, Serpenoid] [Opt: [HighRe Continuous Approx: 20-link ellipses, Serpenoid] [Circle Stroke, 0.25 amplitude] Xeff] Xeff';

function output = shchf_ef7e6818cf228427665d44d18fd56dfa(input_mode,pathnames)
	...
	paramfile = 'ef7e6818cf228427665d44d18fd56dfa';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [Inertial floating: 3-link ellipses] [Circle Stroke, 0.25 amplitude offset for turning] [pathlength metric] Xeff';

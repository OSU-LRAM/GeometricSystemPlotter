function output = shchf_params_circle_1_4shapevariables(input_mode,pathnames)
	...
	paramfile = 'params_circle_1_4shapevariables';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Circular gaits: Amplitude 1, 4 shape variables';

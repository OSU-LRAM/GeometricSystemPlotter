function output = shchf_46c1cf40fe023075bdbf37258c2f764d(input_mode,pathnames)
	...
	paramfile = '46c1cf40fe023075bdbf37258c2f764d';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [HighRe Serpenoid, Four-Mode] [Circle Stroke, 0.25 amplitude] [torque] Xeff';

function output = shchf_dab1630a32d4ee0b4b0029a7b589526f(input_mode,pathnames)
	...
	paramfile = 'dab1630a32d4ee0b4b0029a7b589526f';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [Viscous Swimmer: 3-link CoM_extended] [params_posinclude_extended] Xeff';

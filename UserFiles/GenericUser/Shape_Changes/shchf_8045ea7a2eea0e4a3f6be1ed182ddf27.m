function output = shchf_8045ea7a2eea0e4a3f6be1ed182ddf27(input_mode,pathnames)
	...
	paramfile = '8045ea7a2eea0e4a3f6be1ed182ddf27';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [HighRe ideal swimmer: 4-link ellipses] [Circle Stroke, 1.0 amplitude] [pathlength metric] Xeff';

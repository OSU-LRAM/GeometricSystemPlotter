function output = shchf_07a0c5552b3d0852d5f87f6fcad6d30c(input_mode,pathnames)
	...
	paramfile = '07a0c5552b3d0852d5f87f6fcad6d30c';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [HighRe ideal swimmer: 5-link ellipses] [Circle Stroke, 1.0 amplitude] [pathlength metric] Xeff';

function output = shchf_d27e47de5899af33e7814fd0aaed002d(input_mode,pathnames)
	...
	paramfile = 'd27e47de5899af33e7814fd0aaed002d';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [HighRe ideal swimmer: 4-link ellipses] [Opt: [HighRe ideal swimmer: 4-link ellipses] [Circle Stroke, 1.0 amplitude] Xeff] Xeff';

function output = shchf_6e0b7055f31bbf4e77ccd28690f75aee(input_mode,pathnames)
	...
	paramfile = '6e0b7055f31bbf4e77ccd28690f75aee';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [Inertial floating: 3-link ellipses] [Opt: [Inertial floating: 3-link ellipses] [Circle Stroke, 0.25 amplitude offset for turning] [covariant acceleration] Xeff] [covariant acceleration] Xeff';

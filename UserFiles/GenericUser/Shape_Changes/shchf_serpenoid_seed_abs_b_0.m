function output = shchf_serpenoid_seed_abs_b_0(input_mode,pathnames)
	...
	paramfile = 'serpenoid_seed_abs_b_0';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'serpenoid optimizer start circle, b = 0, abs lambda func';

function output = shchf_4b442e5f83a1a7e8c73e202ff7219a1c(input_mode,pathnames)
	...
	paramfile = '4b442e5f83a1a7e8c73e202ff7219a1c';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [HighRe ideal swimmer: 3-link ellipses] [Opt: [HighRe ideal swimmer: 3-link ellipses] [Circle Stroke, 1.0 amplitude] [torque] Xeff] [torque] Xeff';

function output = shchf_4f0650e83e22d3712741eaad0eaae57b(input_mode,pathnames)
	...
	paramfile = '4f0650e83e22d3712741eaad0eaae57b';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [HighRe Serpenoid, Two-Mode] [Opt: [HighRe Serpenoid, Two-Mode] [Circle Stroke, 0.25 amplitude] [covariant acceleration] Xeff] [covariant acceleration] Xeff';

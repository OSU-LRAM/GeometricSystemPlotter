function output = shchf_22e3bb757c3a8dae54a388d2bf2aaec0(input_mode,pathnames)
	...
	paramfile = '22e3bb757c3a8dae54a388d2bf2aaec0';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [HighRe CC, 3 Mode] [Opt: [HighRe CC, 3 Mode] [Circle Stroke, 6 amplitude] [torque] Xeff] [pathlength metric] Xeff';

function output = shchf_5d65b16e29fab5deddc285c5040fb558(input_mode,pathnames)
	...
	paramfile = '5d65b16e29fab5deddc285c5040fb558';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [HighRe ideal swimmer: 4-link ellipses] [Opt: [HighRe ideal swimmer: 4-link ellipses] [Opt: [HighRe ideal swimmer: 4-link ellipses] [Circle Stroke, 1.0 amplitude] Xeff] Xeff] Xeff';

function output = shchf_36f65157e963179771c57115cf0271bb(input_mode,pathnames)
	...
	paramfile = '36f65157e963179771c57115cf0271bb';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [HighRe ideal swimmer: 5-link ellipses] [Circle Stroke, 1.0 amplitude] [covariant acceleration] Xeff';

function output = shchf_af767cfa1270ea849a38aaa37814ece4(input_mode,pathnames)
	...
	paramfile = 'af767cfa1270ea849a38aaa37814ece4';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [Viscous Swimmer: 3-link] [Opt: [Viscous Swimmer: 4-link] [Circle Stroke, 1.0 amplitude] Xeff] Xeff';

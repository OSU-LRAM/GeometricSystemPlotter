function output = shchf_piecewise_seed_abs_b_0_optimal(input_mode,pathnames)
	...
	paramfile = 'piecewise_seed_abs_b_0_optimal';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'piecewise_seed_abs_b_0_optimal';

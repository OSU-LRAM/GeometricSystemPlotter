function output = shchf_params_optimalgaitconstatcurv3(input_mode,pathnames)
	...
	paramfile = 'params_optimalgaitconstatcurv3';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'params_optimalgaitconstatcurv3';

function output = shchf_ac549576cd57b7ca01d61c80cbe5fa20(input_mode,pathnames)
	...
	paramfile = 'ac549576cd57b7ca01d61c80cbe5fa20';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [HighRe Serpenoid, Four-Mode] [Opt: [HighRe Serpenoid, Four-Mode] [Circle Stroke, 0.25 amplitude] [covariant acceleration] Xeff] [covariant acceleration] Xeff';
		...
		case 'initialize'
            ...
            if alpha1(1)==alpha1(end) && alpha2(1)==alpha2(end) && alpha3(1)==alpha3(end) && alpha4(1)==alpha4(end)
                splinemode = 'periodic';
            else
                splinemode = 'complete';
            end
            ...
            % specified times
			p.phi_def = @(t) [ppval(spline_alpha1,t(:)),ppval(spline_alpha2,t(:)),ppval(spline_alpha3,t(:)),ppval(spline_alpha4,t(:))];
	    ...
	    spline_dalpha4 = ppdiff(spline_alpha4);			
			...
			p.dphi_def = @(t) [ppval(spline_dalpha1,t(:)),ppval(spline_dalpha2,t(:)),ppval(spline_dalpha3,t(:)),ppval(spline_dalpha4,t(:))];

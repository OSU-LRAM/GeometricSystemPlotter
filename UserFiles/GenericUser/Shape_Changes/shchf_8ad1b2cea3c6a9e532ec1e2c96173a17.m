function output = shchf_8ad1b2cea3c6a9e532ec1e2c96173a17(input_mode,pathnames)
	...
	paramfile = '8ad1b2cea3c6a9e532ec1e2c96173a17';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [5-Link Flapper with Passive Joints] [Opt: [5-Link Flapper with Passive Joints] [Opt: [5-Link Flapper with Passive Joints] [Opt: [Viscous Swimmer: 3-link] [Opt: [Viscous Swimmer: 3-link] [Circle Stroke, 1.0 amplitude] Xeff] Xeff] Xeff] Xeff] Xeff';

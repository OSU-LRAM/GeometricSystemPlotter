function output = shchf_162710e4d0a4d9652041839b51af2241(input_mode,pathnames)
	...
	paramfile = '162710e4d0a4d9652041839b51af2241';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [HighRe CC, 4 Mode] [3D Ellipse, Tunable] [pathlength metric] Xeff';

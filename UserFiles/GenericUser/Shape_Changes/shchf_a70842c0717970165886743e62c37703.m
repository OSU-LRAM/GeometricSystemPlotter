function output = shchf_a70842c0717970165886743e62c37703(input_mode,pathnames)
	...
	paramfile = 'a70842c0717970165886743e62c37703';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [HighRe ideal swimmer: 4-link ellipses] [Opt: [HighRe ideal swimmer: 4-link ellipses] [Circle Stroke, 1.0 amplitude] [covariant acceleration] Xeff] [covariant acceleration] Xeff';

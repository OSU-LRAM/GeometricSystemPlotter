function output = shchf_dc716cfe8cfb0a1b051765516f90a963(input_mode,pathnames)
	...
	paramfile = 'dc716cfe8cfb0a1b051765516f90a963';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [Inertial floating: 4-link ellipses] [Circle Stroke, 0.25 amplitude offset for turning] [torque] Xeff';

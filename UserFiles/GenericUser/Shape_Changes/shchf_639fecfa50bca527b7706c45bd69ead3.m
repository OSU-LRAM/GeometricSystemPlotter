function output = shchf_639fecfa50bca527b7706c45bd69ead3(input_mode,pathnames)
	...
	paramfile = '639fecfa50bca527b7706c45bd69ead3';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [HighRe CC, 3 Mode] [Opt: [HighRe CC, 2 Mode] [Circle Stroke, 6 amplitude] [pathlength metric] Xeff] [pathlength metric] Xeff';

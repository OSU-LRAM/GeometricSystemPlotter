function output = shchf_d60e422146951eb707a578dff8e82b98(input_mode,pathnames)
	...
	paramfile = 'd60e422146951eb707a578dff8e82b98';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [HighRe ideal swimmer: 4-link ellipses] [Opt: [HighRe ideal swimmer: 4-link ellipses] [Circle Stroke, 1.0 amplitude] Xeff] [torque] Xeff';

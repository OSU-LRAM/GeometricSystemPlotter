function output = shchf_296a3b872bc736d9985def86405db7ac(input_mode,pathnames)
	...
	paramfile = '296a3b872bc736d9985def86405db7ac';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [Viscous Swimmer: 3-link CoM] [params_limacon] Xeff';

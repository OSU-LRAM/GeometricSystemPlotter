function output = shchf_f2ea57eb3b22fdd497aab4d515e98ddd(input_mode,pathnames)
	...
	paramfile = 'f2ea57eb3b22fdd497aab4d515e98ddd';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [5-Link Flapper with Passive Joints] [Opt: [5-Link Flapper with Passive Joints] [Opt: [Viscous Swimmer: 3-link] [Opt: [Viscous Swimmer: 3-link] [Circle Stroke, 1.0 amplitude] Xeff] Xeff] Xeff] Xeff';

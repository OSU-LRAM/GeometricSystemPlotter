function output = shchf_84d03d7100e497d21c1eac750e34e01c(input_mode,pathnames)
	...
	paramfile = '84d03d7100e497d21c1eac750e34e01c';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [5-Link Flapper with Passive Joints] [Opt: [Viscous Swimmer: 3-link] [Opt: [Viscous Swimmer: 3-link] [Circle Stroke, 1.0 amplitude] Xeff] Xeff] Xeff';

function output = shchf_ab1addeb77695d39cffea6b000b23683(input_mode,pathnames)
	...
	paramfile = 'ab1addeb77695d39cffea6b000b23683';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [HighRe ideal swimmer: 3-link ellipses] [Opt: [HighRe ideal swimmer: 3-link ellipses] [Circle Stroke, 1.0 amplitude] Xeff] Xeff';

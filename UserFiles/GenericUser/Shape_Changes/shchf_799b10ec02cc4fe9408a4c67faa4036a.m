function output = shchf_799b10ec02cc4fe9408a4c67faa4036a(input_mode,pathnames)
	...
	paramfile = '799b10ec02cc4fe9408a4c67faa4036a';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [HighRe Continuous Approx: 20-link ellipses] [Opt: [HighRe Continuous Approx: 20-link ellipses] [Circle Stroke, 1.0 amplitude] Xeff] Xeff';

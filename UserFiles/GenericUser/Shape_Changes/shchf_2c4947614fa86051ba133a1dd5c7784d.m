function output = shchf_2c4947614fa86051ba133a1dd5c7784d(input_mode,pathnames)
	...
	paramfile = '2c4947614fa86051ba133a1dd5c7784d';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [HighRe Serpenoid, Two-Mode] [Circle Stroke, 0.25 amplitude] [covariant acceleration] Xeff';

function output = shchf_a1426aaac2d013b785ac85010736dfce(input_mode,pathnames)
	...
	paramfile = 'a1426aaac2d013b785ac85010736dfce';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [Inertial floating: 4-link ellipses] [Circle Stroke, 0.25 amplitude offset for turning] [pathlength metric] Xeff';

function output = shchf_params_optimalgaitconstatcurv4(input_mode,pathnames)
	...
	paramfile = 'params_optimalgaitconstatcurv4';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Viscous swimmer: 4 segment pcc optimal gait';

function output = shchf_c7c26fa9158c73b10204190b8e23c2bd(input_mode,pathnames)
	...
	paramfile = 'c7c26fa9158c73b10204190b8e23c2bd';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [Inertial floating: 4-link ellipses] [Opt: [Inertial floating: 4-link ellipses] [Circle Stroke, 0.25 amplitude offset for turning] [pathlength metric] Xeff] [covariant acceleration] Xeff';

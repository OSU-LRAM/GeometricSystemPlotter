function output = shchf_params_optimalgaitserpenoid2(input_mode,pathnames)
	...
	paramfile = 'params_optimalgaitserpenoid2';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Viscous swimmer: Serpenoid with 2 shape variables optimal gait';

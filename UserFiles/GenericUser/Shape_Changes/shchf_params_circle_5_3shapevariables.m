function output = shchf_params_circle_5_3shapevariables(input_mode,pathnames)
	...
	paramfile = 'params_circle_5_3shapevariables';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Circular gaits: Amplitude 5, 3 shape variables';

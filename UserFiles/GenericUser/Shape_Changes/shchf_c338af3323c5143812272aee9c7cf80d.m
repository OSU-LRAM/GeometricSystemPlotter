function output = shchf_c338af3323c5143812272aee9c7cf80d(input_mode,pathnames)
	...
	paramfile = 'c338af3323c5143812272aee9c7cf80d';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [HighRe CC, 4 Mode] [3D Ellipse, Tunable] [covariant acceleration] Xeff';

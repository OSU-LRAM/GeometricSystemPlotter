function output = shchf_f80cd292cc95a0ac7a0dad4e703364f1(input_mode,pathnames)
	...
	paramfile = 'f80cd292cc95a0ac7a0dad4e703364f1';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [Inertial floating: 3-link ellipses] [Circle Stroke, 0.25 amplitude offset for turning] [torque] Xeff';

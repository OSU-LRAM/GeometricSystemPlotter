function output = shchf_83a1b4b5e81c57d2ad83fa170edc51b4(input_mode,pathnames)
	...
	paramfile = '83a1b4b5e81c57d2ad83fa170edc51b4';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Opt: [Inertial floating: 3-link ellipses] [Opt: [Inertial floating: 3-link ellipses] [Circle Stroke, 1.0 amplitude] Xeff] Xeff';

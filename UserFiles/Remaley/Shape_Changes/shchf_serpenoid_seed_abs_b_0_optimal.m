function output = shchf_serpenoid_seed_abs_b_0_optimal(input_mode,pathnames)
	...
	paramfile = 'serpenoid_seed_abs_b_0_optimal';
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'serpenoid_seed_abs_b_0_optimal';

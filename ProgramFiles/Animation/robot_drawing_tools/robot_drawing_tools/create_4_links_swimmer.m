function robot = create_4_links_swimmer(parent,data_source,system_name,orientation_color)
...
robot.links = [object_primative;object_primative;object_primative;object_primative];

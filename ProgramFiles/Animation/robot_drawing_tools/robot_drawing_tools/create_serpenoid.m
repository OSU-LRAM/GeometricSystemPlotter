function robot = create_serpenoid(parent,data_source,system_name,orientation_color)
...
body_local_temp = fatbackbone_from_curvature_bases({@serpenoid_1;@serpenoid_2},[0;0],1,.2/6,orientation);

body_local = body_local_temp(1:2,:)';

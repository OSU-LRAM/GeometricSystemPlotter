function animate_floating_snake(export,info_needed)
...
% 	data_source = '/Users/rlhatton/Documents/MATLAB/GeometricSystemPlotter/UserFiles/v4/rlhatton/sysplotter_data/v4.0/';
    ...
    data_source = info_needed.UserFile_path;%'\GSP\UserFiles\v4\Hossein\sysplotter_data\v4.2';
	system_name = info_needed.current_system2;%'honey_swimmer';
	gait_name = info_needed.current_shch2;%'circle_1p25';
...
% 		posdata_theta = posraw(first_index:end,3)'-posraw(end,3)*(start_pos+(i-1));
        posdata_theta = posraw(first_index:end,3)'+ (i-1)*posraw(end,3);

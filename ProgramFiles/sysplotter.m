...
% Last Modified by GUIDE v2.5 09-Sep-2018 15:01:57
	...
	addpath(genpath(GetFullPath('sysplotter_gui_fcns')), genpath(GetFullPath('sys_calcpath_fcns')),...
		...
		genpath(GetFullPath('sys_update_fcns')),genpath(GetFullPath('sysplotter_config_fcns')),...
        genpath(GetFullPath('Utilities')),genpath(GetFullPath('Animation')),genpath(GetFullPath('Physics')),...

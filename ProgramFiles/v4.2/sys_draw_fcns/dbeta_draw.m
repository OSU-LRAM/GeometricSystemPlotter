function plot_info = dbeta_draw(s,p,plot_info,sys,shch,convert,resolution)
    ...
    for i = 1:length(plot_info.axes)
        ...
        if ~plot_info.own_figure
            ...
            set(get(ax(1),'Parent'),'Name',[vfield_list{field_number} ' dBeta Vector Field'])
        
			%Mark this figure as dbetas
